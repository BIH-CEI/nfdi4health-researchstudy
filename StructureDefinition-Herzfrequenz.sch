...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation/f:code">
      ...
      <sch:assert test="count(f:extension[@url = 'https://www.nfdi4health.de/task-force-covid-19.html/StructureDefinition/Freitext']) &lt;= 1">extension with URL = 'https://www.nfdi4health.de/task-force-covid-19.html/StructureDefinition/Freitext': maximum cardinality of 'extension' is 1</sch:assert>
